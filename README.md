...
[2:13 PM, 12/1/2017] Ritu MIS: Since, bitcoin has much higher percentage difference than S & P, its clearly doing better. for the Ethereum graph - Bitcoin is much older than Ethereum which shows it has a history which can be relied upon. Secondly, Ethereum is showing so many irregularities which can't be seen by bitcoin.
